            ...
            <div class="cards mx-auto" style="max-width: 450px">
                <div class="card-body">
                    <form action="loginsv.php" method="post">
                        ...
                        <div class="alert alert-danger alert-dismissible mx-auto" style="max-width: 450px">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            Nomor NISN Anda tidak terdaftar
                        </div>
                        <?php
                            }
                        }
                        ...
                        <?php
                        if (isset($_GET["vote"])) {
                            if ($_GET["vote"] == "berhasil") {
                        ?>
                        <div class="alert alert-success alert-dismissible mx-auto" style="max-width: 450px">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            Anda berhasil memilih kandidat, silahkan login kembali untuk melihat hasil.
                        </div>
                        <?php
                            }
                        }
