...
<body>
    ...
    <div class="navbar navbar-expand-lg navbar-light justify-content-between" style="background-color: #FFC0CB; ">
        <a href="index.php?nav=hasil" class="navbar-brand"><img src="assets/img/2.png" class="rounded" alt="evoting"
                style="width: 50px; height:50px">
            E-Voting OSIS SMP 2
            Kota Jambi</a>
        <ul class="navbar-nav" style="margin-right: 5rem;">
            <li class="nav-item <?php if ($nav == "hasil") echo "active"; ?>"><a
                    href="?nav=hasil&name=<?php echo $_GET["name"]; ?>" class="nav-link">Hasil Sementara</a></li>
            <li class="nav-item <?php if ($nav == "pilih") echo "active"; ?>"><a
                    href="?nav=pilih&name=<?php echo $_GET["name"]; ?>" class="nav-link">Pilih Kandidat</a>
            </li>
            <li class="nav-item dropdown">
                <div class="d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mt-1" width="30" height="30" viewBox="0 0 24 24"
                ...
                <ul class="dropdown-menu ">
                    <li><a class="dropdown-item " href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="30"
                                height="30" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
