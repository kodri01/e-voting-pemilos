...
<body>
    ...
    <div class="row container-fluid" style="margin-top:10rem">
        <div class="col-6">
            <img src="assets/img/evoting.png" class="rounded mx-auto d-block" alt="evoting" style="width: auto; height:500px">
        </div>
        <div class="col-6">
                ...
                <div class="card-body">
                    <form action="loginsv.php" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="nis" id="floatingInput" placeholder="Masukan nomor NISN">
                            <label for="floatingInput">Nomor NISN</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" name="tgl" id="floatingInput" placeholder="Tanggal Lahir">
                            <label for="floatingInput">Tanggal Lahir</label>
                        </div>

                        <button type="submit" class="btn btn-block text-white" style="background-color: #1A00FF;">Login</button>
                    </form>
                </div>
            </div>
